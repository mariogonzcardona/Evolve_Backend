...
class Peleador(RedesSociales,models.Model):
    ...
    foto = models.ImageField(upload_to="peleadores/foto-perfil/",blank=True,null=True,help_text="Imagen de perfil del peleador")
...
class Patrocinador(RedesSociales,models.Model):
    ...
    logo = models.ImageField(upload_to="patrocinadores/logos/",blank=True,null=True,help_text="Logo de la empresa o marca")
